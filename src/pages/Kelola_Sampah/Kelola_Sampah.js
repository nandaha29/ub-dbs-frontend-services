...
import Table_Kelola_Sampah from "../../components/elements/Elements_Kelola_Sampah/Table_Kelola_Sembako/Table_Kelola_Sampah";

export default function Kelola_Sampah(props) {
            ...
            <div className="container-fluid">
              <div className="row mb-2">
                <div className="col-sm-6">
                  <h1 className="m-0">Table_Kelola_Sampah</h1>
                </div>
                {/* /.col */}
                <div className="col-sm-6">
