...
import Table_Riwayat_Sampah from "../../components/elements/Elements_Riwayat_Sampah/Table_Riwayat_Sembako/Table_Riwayat_Sampah";

export default function Riwayat_Sampah(props) {
            ...
            <div className="container-fluid">
              <div className="row mb-2">
                <div className="col-sm-6">
                  <h1 className="m-0">Riwayat_Sampah</h1>
                </div>
                {/* /.col */}
                <div className="col-sm-6">
