...
import TableDataPenjualanSampah from "../../component/data-penjualan-sampah/TableDataPenjualanSampah";

export default class DataPenjualanSampahPage extends Component {
  constructor() {
    super();
    this.state = {
      adminName: "Ferdi",
              ...
              <div className="container-fluid">
                <div className="row mb-2">
                  <div className="col-sm-6">
                    <h1 className="m-0">Data Penjualan Sampah</h1>
                  </div>
                  {/* /.col */}
                  <div className="col-sm-6">
                    <ol className="breadcrumb float-sm-right">
                      ...
                      <li className="breadcrumb-item active">
                        <a href="/data-penjualan-sampah">Data Penjualan Sampah</a>
                      </li>
                    </ol>
                  </div>
                  {/* /.col */}
