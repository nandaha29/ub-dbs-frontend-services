...
class Table_VerNas extends Component {
  constructor() {
    super();
    this.state = {
      data_nasabah: [],
        ...
        return (
          <tr>
            ...
            <td className="d-flex justify-content-center">
              ...
              <button className="btn btn-success btn-sm mt-1 mx-2" data-toggle="modal" data-target="#modal_hapus_akun">
                Hapus akun
              </button>
